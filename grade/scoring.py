...
def main() -> int:
    ...
    parser.add_argument("--provider", default="google", choices=["google", "ollama", "mimo", "openrouter", "openai", "custom"])
    parser.add_argument("--model-name", default=None)
    parser.add_argument("--today", default="2026-06-01")
    parser.add_argument("--pass-threshold", type=float, default=80.0)
    parser.add_argument("--judge-provider", default=None, choices=["google", "ollama", "mimo", "openrouter", "openai", "custom"])
